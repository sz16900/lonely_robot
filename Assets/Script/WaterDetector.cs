...
public class WaterDetector : MonoBehaviour {
    ...
    void OnTriggerStay2D(Collider2D Hit)
    {
        ...
        if (Hit.rigidbody2D != null)
        {
            ...
            {
                transform.parent.GetComponent<Water>().Splash(Hit.transform.position.x - Hit.transform.localScale.x + i * 2 * Hit.transform.localScale.x / points, Hit.rigidbody2D.mass * Hit.rigidbody2D.velocity.x / 10f / points * 2f);
            }
        }
    }
    */
